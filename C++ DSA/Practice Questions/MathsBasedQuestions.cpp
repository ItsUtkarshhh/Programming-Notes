...
// Complementry Question : You are given a number ’n’. Find the number of digits of ‘n’ that evenly divide ‘n’. TC : O(Log10(x)) and SC : O(1)
#include <iostream>
using namespace std;
...
// Question 18 : Reverse a number! TC : O(Log10(x)) and SC : O(1)
#include<iostream>
#include<climits>
using namespace std;
...
// Question 19 : Check whether a number is palindrome or not!
...
// Question 20 : Check whether the given number is armstrong or not! TC : O(log10(x)) and SC : O(1)
#include<iostream>
#include<math.h>
using namespace std;
...
// Question 21 : You are given an integer n. You need to find all the divisors of n. Return all the divisors of n as an array or list in a sorted order.
...
// Question 22 : You are given an integer n. You need to check if the number is prime or not. Return true if it is a prime number, otherwise return false.
